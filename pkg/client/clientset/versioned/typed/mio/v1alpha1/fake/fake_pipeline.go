...
var pipelinesResource = schema.GroupVersionResource{Group: "mio.io", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "mio.io", Version: "v1alpha1", Kind: "Pipeline"}
