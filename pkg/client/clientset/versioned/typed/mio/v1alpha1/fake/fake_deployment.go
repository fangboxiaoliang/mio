...
var deploymentsResource = schema.GroupVersionResource{Group: "mio.io", Version: "v1alpha1", Resource: "deployments"}

var deploymentsKind = schema.GroupVersionKind{Group: "mio.io", Version: "v1alpha1", Kind: "Deployment"}
