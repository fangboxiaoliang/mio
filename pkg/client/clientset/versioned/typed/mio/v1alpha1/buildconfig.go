...
type BuildConfigInterface interface {
	Create(*v1alpha1.BuildConfig) (*v1alpha1.BuildConfig, error)
	Update(*v1alpha1.BuildConfig) (*v1alpha1.BuildConfig, error)
	UpdateStatus(*v1alpha1.BuildConfig) (*v1alpha1.BuildConfig, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.BuildConfig, error)
	List(opts v1.ListOptions) (*v1alpha1.BuildConfigList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.BuildConfig, err error)
...
func newBuildConfigs(c *MioV1alpha1Client, namespace string) *buildConfigs {
	return &buildConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *buildConfigs) Get(name string, options v1.GetOptions) (result *v1alpha1.BuildConfig, err error) {
	result = &v1alpha1.BuildConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *buildConfigs) List(opts v1.ListOptions) (result *v1alpha1.BuildConfigList, err error) {
	result = &v1alpha1.BuildConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("buildconfigs").
...
func (c *buildConfigs) Create(buildConfig *v1alpha1.BuildConfig) (result *v1alpha1.BuildConfig, err error) {
	result = &v1alpha1.BuildConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("buildconfigs").
...
func (c *buildConfigs) Update(buildConfig *v1alpha1.BuildConfig) (result *v1alpha1.BuildConfig, err error) {
	result = &v1alpha1.BuildConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("buildconfigs").
...
func (c *buildConfigs) UpdateStatus(buildConfig *v1alpha1.BuildConfig) (result *v1alpha1.BuildConfig, err error) {
	result = &v1alpha1.BuildConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("buildconfigs").
...
func (c *buildConfigs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.BuildConfig, err error) {
	result = &v1alpha1.BuildConfig{}
